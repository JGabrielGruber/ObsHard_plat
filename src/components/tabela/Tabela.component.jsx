	...
	render() {
		...
		const columns = [
			...
			},
			{
				...
				render: (rowData) => <Typography>{rowData.variacao ? rowData.variacao.nome : ''}</Typography>,
			},
			{
				title: 'Loja',
				field: 'loja.nome',
				...
				render: (rowData) => <Button href={rowData.link}>{rowData.loja ? rowData.loja.nome : ''}</Button>,
				width: 10,
			},
